        ...
        <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="card text-center shadow-sm homie-card">
                <div class="card-body">
                    ...
                    <p id="admin-count" class="card-text">0</p>
                </div>
            </div>
        </div>
        <!-- Coordinator Card -->
        <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="card text-center shadow-sm homie-card">
                <div class="card-body">
                    ...
                    <p id="coordinator-count" class="card-text">0</p>
                </div>
            </div>
        </div>
        <!-- Coach Card -->
        <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="card text-center shadow-sm homie-card">
                <div class="card-body">
                    ...
                    <p id="coach-count" class="card-text">0</p>
                </div>
            </div>
        </div>
        <!-- Students Card -->
        <div class="col-sm-12 col-md-6 col-lg-3">
            <div class="card text-center shadow-sm homie-card">
                <div class="card-body">
                    ...
                    <p id="student-count" class="card-text">0</p>
                </div>
            </div>
        </div>
